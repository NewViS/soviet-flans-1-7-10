...
public class EntityJeep extends Entity implements IInventory {
   ...
   public AxisAlignedBB func_70046_E() {
      return AxisAlignedBB.getBoundingBox(this.field_70121_D.minX, this.field_70121_D.minY + 1.0D, this.field_70121_D.minZ, this.field_70121_D.maxX, this.field_70121_D.maxY, this.field_70121_D.maxZ);
   }
   ...
   public void checkInput() {
      if(this.hasDriver()) {
         ...
         if(Keyboard.isKeyDown(50)) {
            ((EntityPlayer)this.field_70153_n).openGui(RealLifeMod.instance, this.func_145782_y() + GuiVehicleModification.GUI_ID, this.field_70170_p, (int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v);
         }
   ...
   public void move() {
      ...
      double angleVelocity = this.currentspeed / 20.0D * k;
      if(this.currentspeed < this.maxSpeed && this.currentspeed > this.minSpeed) {
         this.currentspeed += this.acceleration;
      }

      this.field_70177_z = (float)((double)this.field_70177_z + angleVelocity);
      this.field_70159_w = Math.sin(Math.toRadians((double)this.field_70177_z)) * this.currentspeed / 10.0D;
      this.field_70179_y = Math.cos(Math.toRadians((double)this.field_70177_z)) * this.currentspeed / 10.0D;
      ...
      if(this.field_70123_F) {
         this.func_70091_d(0.0D, (double)this.field_70138_W, 0.0D);
      }
   ...
   public void func_70043_V() {
      ...
      double var10000 = this.field_70163_u + Math.cos((double)this.field_70125_A * 3.141592653589793D / 180.0D) * this.length;
