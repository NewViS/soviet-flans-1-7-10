...
public class FreezerTE extends TileEntity implements IInventory {

   private ItemStack[] inventory = new ItemStack[15];
   private final String name = "Freezer Inventory";
   private final String tagName = "FreezerInvTag";
   ...
   public boolean func_145818_k_() {
      return "Freezer Inventory".length() > 0;
   }
   ...
   public void func_145839_a(NBTTagCompound p_145839_1_) {
      ...
      NBTTagList nbttaglist = p_145839_1_.getTagList("FreezerItems", 10);
   ...
   public void func_145841_b(NBTTagCompound comp) {
      ...
      comp.setTag("FreezerItems", nbttaglist);
   }
   ...
   public Packet func_145844_m() {
      ...
      dataTag.setTag("FreezerItems", itemList);
      return new S35PacketUpdateTileEntity(this.field_145851_c, this.field_145848_d, this.field_145849_e, 2, dataTag);
   }

   public void onDataPacket(NetworkManager manager, S35PacketUpdateTileEntity packet) {
      NBTTagCompound nbtData = packet.func_148857_g();
      NBTTagList tagList = nbtData.getTagList("FreezerItems", 10);
      this.inventory = new ItemStack[this.func_70302_i_()];
