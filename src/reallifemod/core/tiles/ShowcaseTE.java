...
public class ShowcaseTE extends TileEntity implements ISidedInventory {

   public static final int INV_SIZE = 1;
   private ItemStack[] inventory = new ItemStack[1];
   private final String name = "Showcase Inventory";
   private final String tagName = "ShowcaseInvTag";
   ...
   public void func_70299_a(int slot, ItemStack stack) {
      if(this.func_70301_a(slot) != null) {
         Minecraft.getMinecraft().thePlayer.field_71071_by.addItemStackToInventory(this.func_70301_a(slot));
      }
   ...
   public String func_145825_b() {
      return "reallifemod.Showcaseinventory";
   }

   public boolean func_145818_k_() {
      return "Showcase Inventory".length() > 0;
   }
   ...
   public void func_145839_a(NBTTagCompound p_145839_1_) {
      ...
      NBTTagList nbttaglist = p_145839_1_.getTagList("ShowcaseItems", 10);
   ...
   public void func_145841_b(NBTTagCompound comp) {
      ...
      comp.setTag("ShowcaseItems", nbttaglist);
   }
   ...
   public Packet func_145844_m() {
      ...
      dataTag.setTag("ShowcaseItems", itemList);
   ...
   public void onDataPacket(NetworkManager manager, S35PacketUpdateTileEntity packet) {
      ...
      NBTTagList tagList = nbtData.getTagList("ShowcaseItems", 10);
      this.inventory = new ItemStack[this.func_70302_i_()];
