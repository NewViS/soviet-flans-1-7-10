...
public class EntityCherokee extends Entity {
   ...
   public EntityCherokee(World world) {
      super(world);
      this.isEmpty = true;
   ...
   public AxisAlignedBB func_70114_g(Entity entity) {
      AxisAlignedBB var10000 = entity.boundingBox;
      return AxisAlignedBB.getBoundingBox(-1.0D, 0.0D, 0.0D, 1.0D, 1.0D, 7.0D);
   }
   ...
   public EntityCherokee(World world, double posX, double posY, double posZ) {
      super(world);
   ...
   public double func_70042_X() {
      return (double)(this.field_70131_O + 2.0F - 0.0F);
   }
   ...
   public void func_70071_h_() {
      ...
      if(this.field_70153_n != null && this.field_70153_n instanceof EntityLivingBase) {
         if(Keyboard.isKeyDown(17)) {
            ...
            if(this.velocity < 1.0D) {
               ...
               this.field_70170_p.playSoundEffect(this.field_70165_t, this.field_70163_u, this.field_70161_v, "reallifemod:diesel", 1.0F, this.ccm);
            }
         ...
         if(Keyboard.isKeyDown(31)) {
            ...
            if(this.field_70173_aa % 20 == 5) {
               this.func_85030_a("reallifemod:reversebeep", 1.0F, 1.0F);
            }
         }

         if(Keyboard.isKeyDown(30)) {
            if(this.DeltaSteer < 45.0F) {
               this.DeltaSteer = (float)((double)this.DeltaSteer + 1.75D);
            }
         ...
         if(Keyboard.isKeyDown(205)) {
            if(this.truckRoll < 90.0F) {
               ++this.truckRoll;
            }
         } else if(this.truckRoll > 0.0F) {
            --this.truckRoll;
         }
         ...
         if(Keyboard.isKeyDown(ClientProxy.Key_Horn.getKeyCode()) && this.field_70173_aa % 20 == 2) {
         ...
         if(this.FuelAmount != 0.0F) {
            ...
            this.field_70170_p.playSoundEffect(this.field_70165_t, this.field_70163_u, this.field_70161_v, "diesel_stall", 1.0F, 1.0F);
         }
      }
      ...
      if(this.DeltaSteer != 0.0F) {
         this.R = (double)(5.0F / this.DeltaSteer);
         this.k = 1.0D / this.R;
      }

      if(this.Damage >= 90.0D) {
         this.func_70015_d((int)(100.0D - this.Damage));
         this.damaged = true;
      ...
      this.wheelRotation += this.velocity * 20.0D;
      ...
      double angleVelocity = this.velocity * this.k;
      this.field_70177_z = (float)((double)this.field_70177_z + angleVelocity);
      this.field_70159_w = Math.sin((double)this.field_70177_z * 3.141592653589793D / 180.0D) * this.velocity;
      this.field_70179_y = Math.cos((double)this.field_70177_z * 3.141592653589793D / 180.0D) * this.velocity;
      ...
      if(this.field_70170_p.isRemote && (this.field_70170_p.blockExists((int)(this.field_70165_t + x), 0, (int)(this.field_70161_v + z)) || !this.field_70170_p.getChunkFromBlockCoords((int)this.field_70165_t, (int)this.field_70161_v).isChunkLoaded)) {
         if(this.field_70170_p.blockExists((int)(this.field_70165_t + x), 1, (int)(this.field_70161_v + z))) {
      ...
      if(this.field_70170_p.getBlock((int)(this.field_70165_t + x), (int)(this.field_70163_u - Math.cos((double)this.field_70125_A * 3.141592653589793D / 180.0D) * 6.0D), (int)(this.field_70161_v + z)) == Blocks.air) {
         ++this.field_70125_A;
      }
