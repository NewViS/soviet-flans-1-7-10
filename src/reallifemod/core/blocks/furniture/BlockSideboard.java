...
public class BlockSideboard extends BlockContainer {

   public BlockSideboard() {
      super(Material.iron);
      this.func_149663_c("sideboard");
   ...
   public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int par1, float par2, float par3, float par4) {
      player.openGui(RealLifeMod.instance, GuiSideboard.GUI_ID, world, x, y, z);
      return true;
   }

   public TileEntity func_149915_a(World world, int var2) {
      return new SideboardTE();
   }
