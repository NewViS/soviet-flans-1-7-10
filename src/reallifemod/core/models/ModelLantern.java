...
public class ModelLantern extends ModelBase {
   ...
   public ModelLantern() {
      ...
      this.lamp.addBox(-3.0F, -34.0F, -2.0F, 7, 10, 7);
      this.lamp.setRotationPoint(0.0F, 0.0F, -1.0F);
      this.lamp.setTextureSize(64, 32);
      this.lamp.mirror = true;
      this.setRotation(this.lamp, 0.0F, 0.0F, 0.0F);
      this.post = new ModelRenderer(this, 29, 0);
      this.post.addBox(-1.0F, -24.0F, -1.0F, 3, 48, 3);
