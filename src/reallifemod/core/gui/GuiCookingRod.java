...
public class GuiCookingRod extends GuiContainer {
   ...
   public static final int GUI_ID = 56;


   public GuiCookingRod(InventoryPlayer p_i1083_1_, CookingRodTE tileEntity) {
      super(new ContainerCookingRod(p_i1083_1_, tileEntity));
      this.upperChestInventory = p_i1083_1_;
      this.lowerChestInventory = tileEntity;
      this.field_146291_p = true;
      short short1 = 222;
      int i = short1 - 108;
      this.inventoryRows = tileEntity.func_70302_i_() / 5;
