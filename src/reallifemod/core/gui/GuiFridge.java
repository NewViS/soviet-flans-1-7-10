...
public class GuiFridge extends GuiContainer {
   ...
   public static int GUI_ID = 58;


   public GuiFridge(InventoryPlayer p_i1083_1_, FridgeTE p_i1083_2_) {
      super(new ContainerFridge(p_i1083_1_, p_i1083_2_));
      GUI_ID = 58;
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      this.field_146297_k.getTextureManager().bindTexture(new ResourceLocation("reallifemod:textures/gui/container/Fridge.png"));
