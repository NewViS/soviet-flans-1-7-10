...
import de.ItsAMysterious.mods.reallifemod.core.models.ModelCupboard;
...
public class CupboardTER extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/ModelCupboard.png"));
