...
import de.ItsAMysterious.mods.reallifemod.core.models.ModelComputer;
...
public class ComputerTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom modelHD = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/furniture/Computer.obj"));
   private final ResourceLocation textureMC = new ResourceLocation("reallifemod:textures/tiles/ComputerMC.png");
   private final ResourceLocation texture = new ResourceLocation("reallifemod:textures/tiles/computer.png");
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      ...
      if(RealLifeModConfig.minecraftstyle) {
         ...
         this.func_147499_a(this.textureMC);
