...
public class RailingTER extends TileEntitySpecialRenderer {

   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/furniture/railing.obj"));
   private IModelCustom leftmodel;


   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      this.doRender((RailingTE)te, x, y, z, scale);
   }

   public void doRender(RailingTE te, double x, double y, double z, float scale) {
      GL11.glPushMatrix();
