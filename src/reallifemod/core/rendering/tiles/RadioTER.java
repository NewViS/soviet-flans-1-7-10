...
public class RadioTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/furniture/radio.obj"));
   ...
   public void doRender(RadioTE te, double x, double y, double z, float scale) {
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/radio.png"));
