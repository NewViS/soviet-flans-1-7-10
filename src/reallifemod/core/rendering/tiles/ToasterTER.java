...
public class ToasterTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/furniture/Toaster.obj"));
   ...
   public void doRender(ToasterTE te, double x, double y, double z, float scale) {
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/Toaster.png"));
