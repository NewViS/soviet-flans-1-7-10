...
public class DishwasherTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/everydaylife/dishwasher.obj"));
   ...
   public void doRender(DishwasherTE te, double x, double y, double z, float scale) {
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/dishwasher.png"));
