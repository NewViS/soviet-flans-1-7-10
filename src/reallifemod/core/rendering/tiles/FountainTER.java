...
public class FountainTER extends TileEntitySpecialRenderer {

   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/outdoor/fountain.obj"));


   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      this.doRender((FountainTE)te, x, y, z, scale);
   }

   public void doRender(FountainTE te, double x, double y, double z, float scale) {
      GL11.glPushMatrix();
      GL11.glDisable(2884);
      GL11.glEnable(3008);
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/fountain.png"));
