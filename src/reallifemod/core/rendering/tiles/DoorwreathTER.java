...
import de.ItsAMysterious.mods.reallifemod.core.models.ModelWreath;
...
public class DoorwreathTER extends TileEntitySpecialRenderer {

   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/seasonal/doorwreath.obj"));
   private ModelWreath modelMC = new ModelWreath();


   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      this.doRender((DoorwreathTE)te, x, y, z, scale);
   }

   public void doRender(DoorwreathTE te, double x, double y, double z, float scale) {
      GL11.glPushMatrix();
      GL11.glDisable(2884);
      GL11.glEnable(3008);
      ...
      if(!RealLifeModConfig.minecraftstyle) {
         ...
         this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/Doorwreath.png"));
         this.model.renderAll();
      } else {
         this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/Wreath_MC.png"));
