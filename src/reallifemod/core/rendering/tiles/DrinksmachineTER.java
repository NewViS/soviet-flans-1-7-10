...
public class DrinksmachineTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/furniture/DrinksMachine.obj"));
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      ...
      GL11.glDisable(2884);
      GL11.glEnable(3008);
      GL11.glTranslated((double)((float)x) + 0.5D, (double)((float)y) + 0.001D, (double)((float)z) + 0.5D);
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/DrinksMachine.png"));
