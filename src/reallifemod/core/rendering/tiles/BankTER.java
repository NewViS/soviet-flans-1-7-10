...
public class BankTER extends TileEntitySpecialRenderer {
   ...
   private IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/outdoor/bank.obj"));
   ...
   public void doRender(BankTE te, double x, double y, double z, float scale) {
      ...
      this.func_147499_a(new ResourceLocation("reallifemod:textures/tiles/bank.png"));
