...
public class ItemLowry extends ExtendedItem implements Buyable {

   public static Minecraft mc;


   public ItemLowry() {
      this.func_77655_b("truck");
      this.func_111206_d("reallifemod:MAN");
      this.setPrice(120000.0D);
   }
      ...
      if(movingobjectposition == null) {
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               EntityTruck var34 = new EntityTruck(world, (double)((float)i + 0.5F), (double)((float)var32 + 1.0F), (double)((float)var33 + 0.5F));
