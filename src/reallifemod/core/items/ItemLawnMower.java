...
public class ItemLawnMower extends ExtendedItem {

   public ItemLawnMower() {
      this.func_77655_b("lawnmower");
      this.func_111206_d("reallifemod:WIP");
      this.func_77637_a(RealLifeMod.Outdoor);
      this.setPrice(5899.990234375D);
   }
      ...
      if(movingobjectposition == null) {
         ...
         for(i = 0; i < list.size(); ++i) {
            ...
            if(j.canBeCollidedWith()) {
               ...
               AxisAlignedBB entity = j.boundingBox.expand((double)k, (double)k, (double)k);
               if(entity.isVecInside(vec3)) {
                  flag = true;
               }
            }
         }
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               EntityLawnMower var34 = new EntityLawnMower(world, (double)i + 0.5D, (double)((float)var32 + 1.0F), (double)var33 + 0.5D);
