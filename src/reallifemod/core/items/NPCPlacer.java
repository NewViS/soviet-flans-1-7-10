...
public class NPCPlacer extends ExtendedItem {
   ...
   public NPCPlacer() {
      ...
      this.func_111206_d("reallifemod:npcplacer");
      this.setPrice(50.0D);
   }
      ...
      if(movingobjectposition == null) {
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               ReallifemodNPC var34 = new ReallifemodNPC(world, (double)((float)i + 0.5F), (double)((float)var32 + 1.0F), (double)((float)var33 + 0.5F));
   ...
   public void func_77624_a(ItemStack stack, EntityPlayer player, List list, boolean p_77624_4_) {
      ...
      list.add(EnumChatFormatting.AQUA + "Place all available NPCs from Real Life Mod!");
   }
}
