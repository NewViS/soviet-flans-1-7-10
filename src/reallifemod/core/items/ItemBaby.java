...
public class ItemBaby extends ExtendedItem {

   public ItemBaby() {
      this.func_77655_b("BabyPlacer");
      this.func_111206_d("reallifemod:Baby");
   }
      ...
      if(movingobjectposition == null) {
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               EntityBaby var34 = new EntityBaby(world, (double)i + 0.5D, (double)((float)var32 + 1.0F), (double)var33 + 0.5D);
