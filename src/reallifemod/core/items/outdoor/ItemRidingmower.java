package de.ItsAMysterious.mods.reallifemod.core.items.outdoor;
...
public class ItemRidingmower extends ExtendedItem implements Buyable {

   public static Minecraft mc;


   public ItemRidingmower() {
      this.func_77655_b("ridingmower");
      this.func_111206_d("reallifemod:ridingmower");
      this.func_77637_a(RealLifeMod.Outdoor);
   }
      ...
      if(movingobjectposition == null) {
         ...
         for(i = 0; i < list.size(); ++i) {
            ...
            if(j.canBeCollidedWith()) {
               ...
               AxisAlignedBB truck = j.boundingBox.expand((double)k, (double)k, (double)k);
               if(truck.isVecInside(vec3)) {
                  flag = true;
               }
            }
         }
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               EntityRidingmower var34 = new EntityRidingmower(world, (float)i + 0.5F, (float)var32 + 1.0F, (float)var33 + 0.5F);
