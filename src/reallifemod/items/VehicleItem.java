package de.ItsAMysterious.mods.reallifemod.items;
...
public class VehicleItem extends Item {
   ...
   protected static VehicleData theData;


   public VehicleItem(VehicleData data, String texturename) {
      theData = data;
      VehicleData var10001 = theData;
      this.func_77655_b(VehicleData.getName());
      this.func_111206_d("reallifemod:itemJeep");
   }
      ...
      if(movingobjectposition == null) {
         ...
         for(i = 0; i < list.size(); ++i) {
            ...
            if(j.canBeCollidedWith()) {
               ...
               AxisAlignedBB jeep = j.boundingBox.expand((double)k, (double)k, (double)k);
               if(jeep.isVecInside(vec3)) {
                  flag = true;
               }
            }
         }
         ...
         if(flag) {
            ...
            if(movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
               ...
               EntityJeep var34 = new EntityJeep(world, (double)i + 0.5D, (double)((float)var32 + 1.0F), (double)var33 + 0.5D);
               RealLifeMod.log("Succesfully placed jeep");
