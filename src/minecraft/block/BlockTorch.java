...
public class BlockTorch extends Block {
   ...
   private boolean func_150107_m(World var1, int var2, int var3, int var4) {
      if(World.doesBlockHaveSolidTopSurface(var1, var2, var3, var4)) {
         return true;
      } else {
   ...
   public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
      return var1.isBlockNormalCubeDefault(var2 - 1, var3, var4, true)?true:(var1.isBlockNormalCubeDefault(var2 + 1, var3, var4, true)?true:(var1.isBlockNormalCubeDefault(var2, var3, var4 - 1, true)?true:(var1.isBlockNormalCubeDefault(var2, var3, var4 + 1, true)?true:this.func_150107_m(var1, var2, var3 - 1, var4))));
   }
