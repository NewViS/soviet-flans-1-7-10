...
public class ItemEnchantedBook extends Item {
   ...
   public NBTTagList func_92110_g(ItemStack var1) {
      return var1.stackTagCompound != null && var1.stackTagCompound.hasKey("StoredEnchantments", 9)?(NBTTagList)var1.stackTagCompound.getTag("StoredEnchantments"):new NBTTagList();
   }
