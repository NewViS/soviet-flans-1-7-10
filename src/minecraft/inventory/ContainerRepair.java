...
public class ContainerRepair extends Container {
   ...
   private IInventory inputSlots = new ContainerRepair$1(this, "Repair", true, 2);
   ...
   public ContainerRepair(InventoryPlayer var1, World var2, int var3, int var4, int var5, EntityPlayer var6) {
      ...
      this.addSlotToContainer(new ContainerRepair$2(this, this.outputSlot, 2, 134, 47, var2, var3, var4, var5));
   ...
   public boolean canInteractWith(EntityPlayer var1) {
      return this.theWorld.getBlock(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Blocks.anvil?false:var1.getDistanceSq((double)this.field_82861_i + 0.5D, (double)this.field_82858_j + 0.5D, (double)this.field_82859_k + 0.5D) <= 64.0D;
   }
