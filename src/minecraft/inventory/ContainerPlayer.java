...
public class ContainerPlayer extends Container {
   ...
   public ContainerPlayer(InventoryPlayer var1, boolean var2, EntityPlayer var3) {
      ...
      for(var4 = 0; var4 < 4; ++var4) {
         this.addSlotToContainer(new ContainerPlayer$1(this, var1, var1.getSizeInventory() - 1 - var4, 8, 8 + var4 * 18, var4));
      }
   ...
   public ItemStack transferStackInSlot(EntityPlayer var1, int var2) {
      ...
      if(var4 != null && var4.getHasStack()) {
         ...
         } else if(var3.getItem() instanceof ItemArmor && !((Slot)super.inventorySlots.get(5 + ((ItemArmor)var3.getItem()).armorType)).getHasStack()) {
