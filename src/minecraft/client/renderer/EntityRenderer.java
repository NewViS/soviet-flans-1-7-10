...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void onResourceManagerReload(IResourceManager var1) {
      ...
      if(this.shaderIndex != shaderCount) {
         try {
            this.theShaderGroup = new ShaderGroup(this.mc.getTextureManager(), var1, this.mc.getFramebuffer(), shaderResourceLocations[this.shaderIndex]);
            this.theShaderGroup.createBindFramebuffers(this.mc.displayWidth, this.mc.displayHeight);
   ...
   private float getFOVModifier(float var1, boolean var2) {
      if(this.debugViewDirection > 0) {
         ...
         Block var6 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var3, var1);
      ...
      if(var2 != null) {
         for(int var3 = 0; var3 < 256; ++var3) {
            ...
            if(this.bossColorModifier > 0.0F) {
               var16 = this.bossColorModifierPrev + (this.bossColorModifier - this.bossColorModifierPrev) * var1;
      ...
      if(!this.mc.skipRenderWorld) {
         ...
         if(this.mc.currentScreen != null) {
            ...
            try {
               ...
               var11.addCrashSectionCallable("Screen name", new EntityRenderer$1(this));
               var11.addCrashSectionCallable("Mouse location", new EntityRenderer$2(this, var16, var17));
               var11.addCrashSectionCallable("Screen size", new EntityRenderer$3(this, var13));
   ...
   public void renderWorld(float var1, long var2) {
      ...
      for(int var13 = 0; var13 < 2; ++var13) {
         ...
         if(this.debugViewDirection == 0) {
            ...
            var5.renderEntities(var4, var14, var1);
            RenderHelper.disableStandardItemLighting();
            this.disableLightmap((double)var1);
            GL11.glMatrixMode(5888);
            GL11.glPopMatrix();
   ...
   private void updateFogColor(float var1) {
      ...
      float var11;
      if(this.mc.gameSettings.renderDistanceChunks >= 4) {
         Vec3 var10 = MathHelper.sin(var2.getCelestialAngleRadians(var1)) > 0.0F?Vec3.createVectorHelper(-1.0D, 0.0D, 0.0D):Vec3.createVectorHelper(1.0D, 0.0D, 0.0D);
      ...
      float var23;
      if(this.bossColorModifier > 0.0F) {
         var23 = this.bossColorModifierPrev + (this.bossColorModifier - this.bossColorModifierPrev) * var1;
   ...
   // $FF: synthetic method
   static Minecraft access$000(EntityRenderer var0) {
      return var0.mc;
   }
