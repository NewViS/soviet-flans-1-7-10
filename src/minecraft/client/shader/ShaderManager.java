...
public class ShaderManager {
   ...
   public ShaderUniform func_147984_b(String var1) {
      return (ShaderUniform)(this.field_148009_k.containsKey(var1)?(ShaderUniform)this.field_148009_k.get(var1):defaultShaderUniform);
   }
   ...
   private void func_147996_a(JsonElement var1) {
      JsonObject var2 = JsonUtils.getJsonElementAsJsonObject(var1, "sampler");
