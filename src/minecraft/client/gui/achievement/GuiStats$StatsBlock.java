...
class GuiStats$StatsBlock extends GuiStats$Stats {
   ...
   public GuiStats$StatsBlock(GuiStats var1) {
      ...
      while(var2.hasNext()) {
         ...
         if(GuiStats.access$200(var1).writeStat(var3) > 0) {
            var4 = true;
         } else if(StatList.objectUseStats[var5] != null && GuiStats.access$200(var1).writeStat(StatList.objectUseStats[var5]) > 0) {
            var4 = true;
      ...
      super.field_148216_n = new GuiStats$StatsBlock$1(this, var1);
   }
   ...
   protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5, int var6, int var7) {
      ...
      this.func_148209_a(StatList.objectCraftStats[var10], var2 + 115, var3, var1 % 2 == 0);
      this.func_148209_a(StatList.objectUseStats[var10], var2 + 165, var3, var1 % 2 == 0);
