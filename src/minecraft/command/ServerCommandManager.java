...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void func_152372_a(ICommandSender var1, ICommand var2, int var3, String var4, Object ... var5) {
      boolean var6 = true;
      if(var1 instanceof CommandBlockLogic && !MinecraftServer.getServer().worldServers[0].getGameRules().getGameRuleBooleanValue("commandBlockOutput")) {
         var6 = false;
      }

      ChatComponentTranslation var7 = new ChatComponentTranslation("chat.type.admin", new Object[]{var1.getCommandSenderName(), new ChatComponentTranslation(var4, var5)});
      ...
      if(var6) {
         ...
         while(var8.hasNext()) {
            ...
            if(var9 != var1 && MinecraftServer.getServer().getConfigurationManager().func_152596_g(var9.getGameProfile()) && var2.canCommandSenderUseCommand(var9) && (!(var1 instanceof RConConsoleSource) || MinecraftServer.getServer().func_152363_m())) {
