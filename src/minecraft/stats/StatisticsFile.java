...
public class StatisticsFile extends StatFileWriter {
   ...
   public void func_150882_a() {
      if(this.field_150887_d.isFile()) {
         try {
            super.field_150875_a.clear();
            super.field_150875_a.putAll(this.func_150881_a(FileUtils.readFileToString(this.field_150887_d)));
   ...
   public void func_150883_b() {
      try {
         FileUtils.writeStringToFile(this.field_150887_d, func_150880_a(super.field_150875_a));
      } catch (IOException var2) {
   ...
   public void func_150873_a(EntityPlayer var1, StatBase var2, int var3) {
      ...
      if(var2.isAchievement() && var4 == 0 && var3 > 0) {
         ...
         if(this.field_150890_c.func_147136_ar()) {
            this.field_150890_c.getConfigurationManager().sendChatMsg(new ChatComponentTranslation("chat.type.achievement", new Object[]{var1.func_145748_c_(), var2.func_150955_j()}));
         }
      }
   ...
   public void func_150877_d() {
      Iterator var1 = super.field_150875_a.keySet().iterator();
