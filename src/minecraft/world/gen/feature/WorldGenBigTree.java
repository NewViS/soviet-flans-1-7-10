...
public class WorldGenBigTree extends WorldGenAbstractTree {
         ...
         while(var13 <= var7) {
            ...
            if(var15 > (double)(var4 * var4)) {
               ...
               if(var14.getMaterial() != Material.air && var14.getMaterial() != Material.leaves) {
                  ...
                  this.setBlockAndNotifyAdequately(this.worldObj, var11[0], var11[1], var11[2], var6, 0);
                  ++var13;
               }
            }
         }
   ...
   void generateLeafNode(int var1, int var2, int var3) {
      ...
      for(int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4) {
         ...
         this.func_150529_a(var1, var4, var3, var6, (byte)1, Blocks.leaves);
      }
   ...
   void func_150530_a(int[] var1, int[] var2, Block var3) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            ...
            this.setBlockAndNotifyAdequately(this.worldObj, var14[0], var14[1], var14[2], var3, var17);
         }
