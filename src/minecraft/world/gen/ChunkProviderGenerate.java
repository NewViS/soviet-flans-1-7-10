...
public class ChunkProviderGenerate implements IChunkProvider {
   ...
   public ChunkProviderGenerate(World var1, long var2, boolean var4) {
      ...
      this.field_147435_p = var1.getWorldInfo().getTerrainType();
   ...
   public void replaceBlocksForBiome(int var1, int var2, Block[] var3, byte[] var4, BiomeGenBase[] var5) {
      ...
      this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (double)(var1 * 16), (double)(var2 * 16), 16, 16, var6 * 2.0D, var6 * 2.0D, 1.0D);

      for(int var8 = 0; var8 < 16; ++var8) {
         for(int var9 = 0; var9 < 16; ++var9) {
            BiomeGenBase var10 = var5[var9 + var8 * 16];
            var10.genTerrainBlocks(this.worldObj, this.rand, var3, var4, var1 * 16 + var8, var2 * 16 + var9, this.stoneNoise[var9 + var8 * 16]);
         }
      }
   ...
   public Chunk provideChunk(int var1, int var2) {
      ...
      if(this.mapFeaturesEnabled) {
         this.mineshaftGenerator.func_151539_a(this, this.worldObj, var1, var2, var3);
         this.villageGenerator.func_151539_a(this, this.worldObj, var1, var2, var3);
         this.strongholdGenerator.func_151539_a(this, this.worldObj, var1, var2, var3);
   ...
   private void func_147423_a(int var1, int var2, int var3) {
      ...
      double var8 = 512.0D;
      double var10 = 512.0D;
      this.field_147426_g = this.noiseGen6.generateNoiseOctaves(this.field_147426_g, var1, var3, 5, 5, 200.0D, 200.0D, 0.5D);
      this.field_147427_d = this.field_147429_l.generateNoiseOctaves(this.field_147427_d, var1, var2, var3, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
      this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, var1, var2, var3, 5, 33, 5, 684.412D, 684.412D, 684.412D);
      this.field_147425_f = this.field_147432_k.generateNoiseOctaves(this.field_147425_f, var1, var2, var3, 5, 33, 5, 684.412D, 684.412D, 684.412D);
      boolean var45 = false;
      boolean var44 = false;
      int var12 = 0;
      int var13 = 0;
   ...
   public ChunkPosition func_147416_a(World var1, String var2, int var3, int var4, int var5) {
      return "Stronghold".equals(var2) && this.strongholdGenerator != null?this.strongholdGenerator.func_151545_a(var1, var3, var4, var5):null;
   }
