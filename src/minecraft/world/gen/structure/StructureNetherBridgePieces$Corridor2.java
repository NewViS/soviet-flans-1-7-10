...
public class StructureNetherBridgePieces$Corridor2 extends StructureNetherBridgePieces$Piece {
   ...
   public static StructureNetherBridgePieces$Corridor2 createValidComponent(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
      ...
      this.fillWithBlocks(var1, var3, 0, 2, 0, 0, 5, 4, Blocks.nether_brick, Blocks.nether_brick, false);
      this.fillWithBlocks(var1, var3, 0, 3, 1, 0, 4, 1, Blocks.nether_brick_fence, Blocks.nether_brick_fence, false);
      this.fillWithBlocks(var1, var3, 0, 3, 3, 0, 4, 3, Blocks.nether_brick_fence, Blocks.nether_brick_fence, false);
      this.fillWithBlocks(var1, var3, 4, 2, 0, 4, 5, 0, Blocks.nether_brick, Blocks.nether_brick, false);
      this.fillWithBlocks(var1, var3, 1, 2, 4, 4, 5, 4, Blocks.nether_brick, Blocks.nether_brick, false);
      ...
      if(this.field_111020_b) {
         ...
         if(var3.isVecInside(var5, var4, var6)) {
            ...
            this.generateStructureChestContents(var1, var3, var2, 1, 2, 3, StructureNetherBridgePieces$Piece.field_111019_a, 2 + var2.nextInt(4));
         }
      }
