      ...
      for(int var8 = 0; var8 < var4; ++var8) {
         for(int var9 = 0; var9 < var3; ++var9) {
            ...
            if(var10 != 0 && var11 >= 2 && (var11 - 2) % 29 == 1 && var10 < 128) {
               ...
               } else if(compareBiomesById(var10, BiomeGenBase.mesaPlateau_F.biomeID)) {
               ...
               if(var13 == var10) {
                  ...
                  int var18 = 0;
                  if(compareBiomesById(var14, var10)) {
                     ++var18;
                  }

                  if(compareBiomesById(var15, var10)) {
                     ++var18;
                  }

                  if(compareBiomesById(var16, var10)) {
                     ++var18;
                  }

                  if(compareBiomesById(var17, var10)) {
                     ++var18;
                  }
