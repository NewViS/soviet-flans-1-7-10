...
import net.minecraft.world.gen.layer.GenLayerEdge$SwitchMode;
...
public class GenLayerEdge extends GenLayer {
   ...
   private int[] getIntsCoolWarm(int var1, int var2, int var3, int var4) {
      ...
      int var7 = 1 + var3 + 1;
      int var8 = 1 + var4 + 1;
      int[] var9 = super.parent.getInts(var5, var6, var7, var8);
   ...
   private int[] getIntsSpecial(int var1, int var2, int var3, int var4) {
      int[] var5 = super.parent.getInts(var1, var2, var3, var4);
