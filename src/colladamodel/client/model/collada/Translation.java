...
public class Translation extends Transform {
   ...
   public void apply() {
      GL11.glTranslated(this.vec.xCoord, this.vec.yCoord, this.vec.zCoord);
   }

   public void applyAnimation(double time) {
      GL11.glTranslated(this.animationX == null?this.vec.xCoord:this.animationX.getValue(time), this.animationY == null?this.vec.yCoord:this.animationY.getValue(time), this.animationZ == null?this.vec.zCoord:this.animationZ.getValue(time));
   }
