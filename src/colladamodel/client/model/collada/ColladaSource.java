...
public class ColladaSource {
   ...
   public float getFloat(String param, Integer index) {
      return this.float_data[index.intValue() * this.stride + this.getParamOffset(param)];
   }
   ...
   public float getFloat(Integer paramOffset, Integer index) {
      return this.float_data[index.intValue() * this.stride + paramOffset.intValue()];
   }
   ...
   public String getString(String param, Integer index) {
      return this.getString(Integer.valueOf(this.getParamOffset(param)), index);
   }

   public String getString(Integer paramOffset, Integer index) {
      return this.string_data[index.intValue() * this.stride + paramOffset.intValue()];
   }
}
