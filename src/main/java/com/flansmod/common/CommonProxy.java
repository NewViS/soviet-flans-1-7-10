...
public class CommonProxy
{
	...
	public Container getServerGui(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		case 4: return new ContainerDriveableMenu(player.inventory, world, true, false, ((EntitySeat)player.ridingEntity).driveable);
		...
		case 8: return new ContainerDriveableMenu(player.inventory, world, true, false, ((EntitySeat)player.ridingEntity).driveable);
		...
		case 13: return new ContainerDriveableMenu(player.inventory, world, false, true, ((EntitySeat)player.ridingEntity).driveable);
}
		return null;
	}
