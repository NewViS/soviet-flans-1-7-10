...
public class Modelzil130new extends SovietModelVehicleReaSpar //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	public Modelzil130new() //Same as Filename
	{	    	
	 ...
	 public void renderTexturedParts(){ 
		 ...
		 Minecraft.getMinecraft().renderEngine.bindTexture(zildisk);
			...
			model.renderPart("farbl_1");
			model.renderPart("faricr_1");
