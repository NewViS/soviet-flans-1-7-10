...
public class Modelvaz2109 extends SovietModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	public Modelvaz2109() //Same as Filename
	{	    	
