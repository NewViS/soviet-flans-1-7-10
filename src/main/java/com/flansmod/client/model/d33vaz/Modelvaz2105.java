...
public class Modelvaz2105 extends SovietModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	public Modelvaz2105() //Same as Filename
	{	    	
		    steer = color; //new ResourceLocation("d33vaz:textures/model/color.png");
		    ResourceLocation ArbolPlataform = new ResourceLocation("minecraft:d33vaz/textures/model/vaz2105.obj");
