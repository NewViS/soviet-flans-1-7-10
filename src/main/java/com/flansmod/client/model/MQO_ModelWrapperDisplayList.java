...
import jp.amrex.modelloader.MQO_GroupObject;
import jp.amrex.modelloader.MQO_MetasequoiaObject;
import net.minecraftforge.client.model.IModelCustom;
//import net.minecraftforge.client.model.obj.GroupObject;
//import net.minecraftforge.client.model.obj.WavefrontObject;

public class MQO_ModelWrapperDisplayList implements IModelCustom
{
    ...
    public MQO_ModelWrapperDisplayList(MQO_MetasequoiaObject model)
    {
        type = model.getType();
        int list = GL11.glGenLists(model.groupObjects.size());
        for (MQO_GroupObject obj : model.groupObjects) {
