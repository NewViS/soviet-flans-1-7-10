...
{  
    ...
    public static KeyBinding redplus = new KeyBinding("Red Plus", Keyboard.KEY_NUMPAD9, "Soviet Flan's Mod");
    public static KeyBinding redminus = new KeyBinding("Red Minus", Keyboard.KEY_NUMPAD7, "Soviet Flan's Mod");
    
    public static KeyBinding greenplus = new KeyBinding("Green Plus", Keyboard.KEY_NUMPAD6, "Soviet Flan's Mod");
    public static KeyBinding greenminus = new KeyBinding("Green Minus", Keyboard.KEY_NUMPAD4, "Soviet Flan's Mod");
    
    public static KeyBinding blueplus = new KeyBinding("Blue Plus", Keyboard.KEY_NUMPAD3, "Soviet Flan's Mod");
    public static KeyBinding blueminus = new KeyBinding("Blue Minus", Keyboard.KEY_NUMPAD1, "Soviet Flan's Mod");
    
    public static KeyBinding keyBrake = new KeyBinding("Brake Key", Keyboard.KEY_NONE, "Soviet Flan's Mod");

    /*public static KeyBinding gearDown = new KeyBinding("Brake Key", Keyboard.KEY_NONE, "Soviet Flan's Mod");
    public static KeyBinding gearUp = new KeyBinding("Brake Key", Keyboard.KEY_NONE, "Soviet Flan's Mod");
    public static KeyBinding gearMode = new KeyBinding("Brake Key", Keyboard.KEY_NONE, "Soviet Flan's Mod");*/
	...
	public KeyInputHandler()
	{
		...
		ClientRegistry.registerKeyBinding(gearMode);*/
	...
	public void onKeyInput(KeyInputEvent event)
	{
		...
		if(ridingEntity instanceof IControllable)
		{
			...
			if(redplus.isPressed())
				riding.pressKey(18, player);
			if(redminus.isPressed())
				riding.pressKey(19, player);
			
			if(greenplus.isPressed())
				riding.pressKey(20, player);
			if(greenminus.isPressed())
				riding.pressKey(21, player);
			
			if(blueplus.isPressed())
				riding.pressKey(22, player);
			if(blueminus.isPressed())
				riding.pressKey(23, player);
			
			if(mc.gameSettings.keyBindJump.isPressed()||keyBrake.isPressed())
